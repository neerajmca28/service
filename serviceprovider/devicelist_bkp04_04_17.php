...
left join device on ChallanDetail.deviceid=device.device_id left join sim on device.sim_id=sim.sim_id
 where  device.device_status=64 and ChallanDetail.branchid=".$_SESSION['BranchId']." and ChallanDetail.CurrentRecord=1");
    ...
    ?>  
     <tr align="Center">
        <!--<td><?php echo $i ?></td>-->
            ...
            <td   align="center">
            <? $sql="select * from installer  where inst_id=". $row["installerid"];
