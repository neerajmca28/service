...
if($errMSG=="")
    {
		...
		{
		mysql_query("UPDATE installation_request SET close_date='".date("Y-m-d")."', installation_made='".$close_inst_row['total_row']."', installation_status=5 WHERE id='".$inst_req_id."'",$dblink2);
		}		
...
<form method="post" action="" name="form3">
	...
	<table style="width: 900px;" cellspacing="2" cellpadding="3" border="1">
		<tr>
            ...
            <td align="center"> 
	            <label><strong><?php echo $sales['name'];?></strong> </label>
            </td>
            
            <td  align="right"><strong>Client Name:</strong></td>
            <td align="center">
            	<label><strong><?php echo $rows['company_name'];?></strong> </label></td>
                
            <td  align="right"><strong>No.Of Vehicle:</strong></td>
            <td align="center"> 
                    <label><strong><?php echo $rows['no_of_vehicals'];?></strong> </label></td>
        </tr>
        <tr>
            ...
            <td align="center">
                <label><strong><?php echo $rows['time'];?></strong> </label></td>
            
            <td  align="right"><strong>Vehicle Type: </strong></td>
            <td align="center">
                <label><strong><?php echo $rows['veh_type'];?></strong> </label></td>
       </tr>
       <tr>
          <td  align="right"><strong>Device Model:</label></strong></td>
          <td align="center"> <label><strong><?php echo $rows['model'];?></strong> </label></td>
          
          <td  align="right"><strong>Immobilizer:</label></strong></td>
          <td align="center"> <label><strong><?php echo $rows['immobilizer_type'];?></strong> </label></td>
          
          <td  align="right"><strong>DIMTS:</label></strong></td>
          <td align="center"> <label><strong><?php echo $rows['dimts'];?></strong> </label></td>
       </tr>
       <tr>
          <td  align="right"><strong>Demo:</label></strong></td>
          <td align="center"> <label><strong><?php echo $rows['demo'];?></strong> </label></td>
          
          <td  align="right"><strong>Payment Request:</label></strong></td>
          <td align="center"> <label><strong><?php echo $rows['payment_req'];?></strong> </label></td>
       ...
       <tr>
          ...
          <td align="center"> <label><strong><?php echo $rows['contact_number'];?></strong> </label></td>
          
          <td  align="right"><strong>Contact Person:</label></strong></td>
          <td align="center"> <label><strong><?php echo $rows['contact_person'];?></strong> </label></td>
          <td colspan="2">&nbsp;</td>
       </tr>
   </table>
    ...
    <table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="2"><input name="id" type="hidden" id="id" value="<?php echo $rows['id'];?>">
             ...
             <input type="hidden" name="inst_approve" id="inst_approve" value="<?=$rows['installation_approve'];?>"/>
             ...
             <input type="hidden" name="inst_req_id" id="inst_req_id" value="<?php echo $rows['inst_req_id'];?>" />
             </td>
        </tr>
        ...
        <!--<tr>
         ...
         <? if($_GET['show']=="close" && $rows['instal_reinstall']=='installation'){?>
        ...
        <?php  
			...
			if(($rows['branch_id']==1 && $rows['inter_branch']==0 && $rows['instal_reinstall']=='installation') || ($rows['inter_branch']==1 && $rows['branch_id']!=1 && $rows['instal_reinstall']=='installation'))
			{
				$inst_approve = $rows['installation_approve'];
			}
			elseif($rows['instal_reinstall']=='installation')
			{
	   ...
	   <?php } 
	   ...
	   else if($_GET['show']=="close" && $rows['instal_reinstall']=='re_install'){ ?>
        ...
        <td height="32" align="right">Installtion made*:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>
        <select name="Installtion_Made" id="Installtion_Made" onchange="ReInstalltion(this.value,<?echo $rows['user_id']?>)">
        <option value="">Select Number</option>
        <?php  
			$row_inst_made = $rows['installation_made'];
			if($rows['instal_reinstall']=='re_install')
			{
				$inst_approve = $rows['no_of_vehicals'];
			}
			$total = $inst_approve - $row_inst_made;
