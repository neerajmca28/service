...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
 ...
 <?}?>
	...
	?>
		...
		<!--<td width="12%" align="center">&nbsp;<?php echo $rs[$i]['dimts'];?></td>
		<td width="12%" align="center">&nbsp;<?php echo $rs[$i]['demo'];?></td>
		<td width="12%" align="center">&nbsp;<?php echo $rs[$i]['payment_req'];?></td>
		<td width="9%" align="center">&nbsp;<?php echo $rs[$i]['veh_type'];?></td>
		<td width="9%" align="center">&nbsp;<?php echo $rs[$i]['immobilizer_type'];?></td>
		<td width="9%" align="center">&nbsp;<?php echo $rs[$i]['contact_number'];?></td>
		<td width="13%" align="center">&nbsp;<?php echo $rs[$i]['inst_name'];?></td>
		<td width="8%" align="center">&nbsp;<?php echo $rs[$i]['inst_cur_location'];?></td>
		<!--<td width="7%" align="center">&nbsp;<?php echo $rs[$i]['reason'];?></td> 
		<td width="4%" align="center">&nbsp;<?php echo @date('d-M-Y h:m:s',@strtotime($rs[$i]['rtime']));?></td>
       
         <td width="4%" align="center">&nbsp;<?php echo $rs[$i]['payment']."/".$rs[$i]['billing'];?></td>
         
         <td width="4%" align="center">&nbsp;<?php echo $rs[$i]['datapullingtime'];?></td>-->
