   ...
   switch($_SESSION['ParentId'])
    {
        ...
        <h3>Service Calling</h3>
            <ul class="nav">
             <li><a   href="<?php echo __SITE_URL;?>/servicecalling/ser_request_list.php">Service Request(<? echo getcountRow("SELECT * FROM services_crack WHERE  (service_status='1' or service_status='3') and branch_id=".$_SESSION['BranchId'] ."  and request_by='".$_SESSION['username']."'");?>)</a></li>
       ...
       case '2':
        ...
        <?php } ?>
           ...
           {*/?>
                ...
                <li> <a   href="<?php echo __SITE_URL;?>/serviceprovider/new_installation.php">Open Installtion(<? echo getcountRow("SELECT * FROM installation_request WHERE installation_status='1' and ((inter_branch=0 and branch_id='".$_SESSION['BranchId']."') or (inter_branch='".$_SESSION['BranchId']."' and branch_id!='".$_SESSION['BranchId']."'))");?>)</a></li>
