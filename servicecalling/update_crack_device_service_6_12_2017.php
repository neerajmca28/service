...
<!-- 
    ...
    <tr>
     ...
     <table style="padding-left: 700px;width: 800px;" cellspacing="5" cellpadding="5">
      ...
      <tr>
            ...
            <td><input type="text" name="contact_person[]" id="contact_person"  value="<?=$result['pname']?>"  pattern="[a-zA-Z]{3,}" title="Please enter only Characters" style="width:147px"/>
            </td>

           <td height="32" align="right">Contact Number:<font color="red">* </font></td>
            <td><input type="text" name="contact_number[]" id="contact_number" minlength="10"  maxlength="10"  value="<?=$result['cnumber']?>"    onkeypress='return event.charCode >= 48 && event.charCode <= 57'  style="width:147px"/>
           </td>       
      </tr>
    ...
    <tr>
            ...
            <td><input type="text" name="contact_person[]" id="contact_person"  value="<?=$result['alt_cont_person']?>" pattern="[a-zA-Z]{3,}" title="Please enter only Characters" style="width:147px"/>
            </td>

           <td height="32" align="right">Contact Number:  </td>
            <td><input type="text" name="contact_number[]" id="contact_number"  minlength="10" maxlength="10" value="<?=$result['alter_contact_no']?>"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'  style="width:147px"/>
           </td>       
      </tr>
      <?php }?>
  </table>
        ...
        // alert(res_reg[0]);
         ...
         //alert(hidden_reg_veh);
           ...
           for(var i =1; i <= total; i++)
           {
               ...
               var k=i-1;
               //alert(res_imei[k]);
                var age1 = `<tr><td>Vehicle Reg. No.:<font color="red">*</font></td><td><input type='text'  name="reg_no${i}" id="reg_no${i}" value=`+res_reg[k]+`></td><td>Imei No.:<font color="red">*</font></td><td><input type='text' name='device_imei${i}' id="device_imei${i}" value=`+res_imei[k]+`> </td></tr>`;
                $("#tt").append(age1);
